...
Quality references set the standard for a coherent, finished environment; they do not prescribe another game's composition or painting style. Compose our space through differences in scale, material, lighting, and distance: a cropped nearby moon, a smaller clouded planet across the void, and a distant irregular galactic band. Build that band as a volume with fine filaments, concentrated emission, and fractured dark lanes; keep open black space between features. Avoid a full-screen fog wash or a vortex arranged around a borrowed focal point.
