...
Use [Igloo Inc.](https://www.igloo.inc/) as the standard for environmental depth, tactile materials, and controlled directional lighting. Compose our lunar viewpoint through differences in scale and distance: fine dust and sparse embedded stones nearby, broad shallow craters, and low distant ridgelines. Keep contours smooth and material relief restrained; avoid jagged noise, coarse facets, and blotchy shadows. Keep the animated stars and eyes. The surrounding sky stays open and black, without Earth, a nebula, cloud ceiling, or fog wash.

The lunar surface uses the shared directional light and the starfield's initial observer origin, so camera movement reveals their different depths. The ground has displaced crater geometry, smooth height-field normals, gradual baked sunlight visibility, and a dedicated regolith material with fine surface relief; a globe's colour map is not a close-up soil texture. Stars retain their spatial formation and facets but render at sky depth, behind the ground. World 2 uses irregular gas bands and translucent particulate rings with a shadow cast by its globe. Keep celestial geometry at full depth; do not squash its Z scale to imitate a flat illustration. Small asteroid clusters remain secondary accents at the edges. Mobile compositions reposition landmarks and reduce debris count.
