...
- World 1: the observer stands on the Moon, looking across cratered regolith toward a distant ringless planet and scattered stars in open black space. A low, irregular horizon separates the rocky foreground from the sky; keep the central reading area above it. Keep only a few small sculpted eyes at the periphery above the ground, facing the viewer. Coloured disks emerge from the centre, expand outward, and continuously recycle inside a fixed pointed almond. Use flat disk colours without glossy catchlights; keep the space dominant. Each eye blinks briefly on its own schedule, with the lids closing over the cycling face.
...
Use [Igloo Inc.](https://www.igloo.inc/) as the standard for environmental depth, tactile materials, and controlled directional lighting. Compose our lunar viewpoint through differences in scale and distance: nearby granular soil and embedded rocks, excavated crater walls, distant ridgelines, and a smaller clouded planet across the void. Keep the stars. The surrounding sky stays open and black, without a nebula, cloud ceiling, or fog wash.

The lunar surface and celestial landmarks share a directional light and the starfield's initial observer origin, so camera movement reveals their different depths. The ground has displaced crater geometry, baked sunlight visibility, and a dedicated regolith material with surface relief; a globe's colour map is not a close-up soil texture. Stars retain their spatial formation and facets but render at sky depth, behind the ground and planets. The ringless planet has terrain, cloud cover, ocean reflections, and a restrained atmospheric limb. World 2 uses irregular gas bands and translucent particulate rings with a shadow cast by its globe. Keep celestial geometry at full depth; do not squash its Z scale to imitate a flat illustration. Small asteroid clusters remain secondary accents at the edges. Mobile compositions reposition landmarks and reduce debris count.
