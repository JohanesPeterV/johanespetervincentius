...
export default function Home() {
  return (
    <main className="group relative h-screen w-full overflow-hidden [&_[data-visible]:first-child]:!invisible">
      ...
      <div className="pointer-events-none fixed inset-0 z-20 flex items-center justify-center opacity-0 transition-opacity duration-700 group-has-[[data-visible=true]:first-child]:opacity-100 [&_a]:pointer-events-auto [&_button]:pointer-events-auto">
        <LinktreeSection />
      </div>
      <RandomColorButton
