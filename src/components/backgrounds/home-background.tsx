...
const HomeBackground = (): ReactElement => {
  ...
  const centerQuietGradient = `radial-gradient(circle at 36% 48%, transparent 0%, transparent 20%, ${backgroundColor}2c 54%, ${backgroundColor}ba 100%)`;
