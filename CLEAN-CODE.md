...
Hard constraints live in `AGENTS.md`, `FRONTEND-CODE-STANDARDS.md`, `GIT.md`, and `queue/AGENTS.md`. This file is not a hard gate — it answers a different question: when multiple valid solutions exist, which one fits this codebase best?
